...
// 2. Animate on Scroll
// --------------------
$(function(){AOS.init({offset:64,easing:"ease-in-out-quart",duration:600})}),$(function(){window.addEventListener("load",AOS.refresh)});var prev=0,$window=$(window),nav=$(".scrollhide-nav");$window.off("scroll"),$window.on("scroll",function(){var t=$window.scrollTop();t<0&&(t=0),nav.toggleClass("hidden",prev<t),prev=t});var carousel=document.querySelector(".index__gallery");$(".index__gallery").flickity({
// options
//   contain: true,
//   setGallerySize: false,
wrapAround:!0,prevNextButtons:!1,pageDots:!1}),$("#video-gallery").lightGallery({selector:".excerpt",youtubePlayerParams:{modestbranding:1,showinfo:0,rel:0,controls:0},vimeoPlayerParams:{autoplay:0,title:0,byline:0,portrait:0,color:"FFFFFF"}});
/*
